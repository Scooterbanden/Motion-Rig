...
#define UI_ENC_SW_Pin GPIO_PIN_3
#define UI_ENC_SW_GPIO_Port GPIOA
#define S4_Enable_Pin GPIO_PIN_4
#define S4_Enable_GPIO_Port GPIOA
#define S4_Ready_Pin GPIO_PIN_5
#define S4_Ready_GPIO_Port GPIOA
...
#define S4_Treach_Pin GPIO_PIN_4
#define S4_Treach_GPIO_Port GPIOC
#define S4_EncA_Pin GPIO_PIN_9
#define S4_EncA_GPIO_Port GPIOE
#define S4_EncZ_Pin GPIO_PIN_10
#define S4_EncZ_GPIO_Port GPIOE
#define S4_EncB_Pin GPIO_PIN_11
#define S4_EncB_GPIO_Port GPIOE
#define LogicShifter_OE_Pin GPIO_PIN_13
#define LogicShifter_OE_GPIO_Port GPIOE
#define S3_Enable_Pin GPIO_PIN_14
#define S3_Enable_GPIO_Port GPIOE
#define S3_Direction_Pin GPIO_PIN_15
#define S3_Direction_GPIO_Port GPIOE
#define Alt_EncA_Pin GPIO_PIN_10
#define Alt_EncA_GPIO_Port GPIOB
#define S3_Ready_Pin GPIO_PIN_11
#define S3_Ready_GPIO_Port GPIOB
#define S3_Treach_Pin GPIO_PIN_12
#define S3_Treach_GPIO_Port GPIOB
#define S3_EncZ_Pin GPIO_PIN_13
#define S3_EncZ_GPIO_Port GPIOB
#define S2_PulseGP_Pin GPIO_PIN_14
#define S2_PulseGP_GPIO_Port GPIOB
#define S2_Enable_Pin GPIO_PIN_10
...
#define S2_Treach_Pin GPIO_PIN_14
#define S2_Treach_GPIO_Port GPIOD
#define S2_Ready_Pin GPIO_PIN_15
#define S2_Ready_GPIO_Port GPIOD
...
#define S1_Treach_Pin GPIO_PIN_8
#define S1_Treach_GPIO_Port GPIOA
#define S1_Ready_Pin GPIO_PIN_9
#define S1_Ready_GPIO_Port GPIOA
...
#define S1_Enable_Pin GPIO_PIN_12
#define S1_Enable_GPIO_Port GPIOC
#define S1_Direction_Pin GPIO_PIN_0
#define S1_Direction_GPIO_Port GPIOD
#define S2_EncZ_Pin GPIO_PIN_1
#define S2_EncZ_GPIO_Port GPIOD
#define S1_EncZ_Pin GPIO_PIN_2
