...
void HAL_LPTIM_MspDeInit(LPTIM_HandleTypeDef* hlptim)
{
  if(hlptim->Instance==LPTIM2)
  {
    ...
    PD11     ------> LPTIM2_IN2
    */
    HAL_GPIO_DeInit(Alt_EncA_GPIO_Port, Alt_EncA_Pin);

    HAL_GPIO_DeInit(Alt_EncB_GPIO_Port, Alt_EncB_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  if(htim_encoder->Instance==TIM1)
  {
    ...
    PE11     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOE, S4_EncA_Pin|S4_EncB_Pin);
  ...
  else if(htim_encoder->Instance==TIM2)
  {
    ...
    PB3 (JTDO/TRACESWO)     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(S2_EncA_GPIO_Port, S2_EncA_Pin);

    HAL_GPIO_DeInit(S2_EncB_GPIO_Port, S2_EncB_Pin);
  ...
  else if(htim_encoder->Instance==TIM3)
  {
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOB, S1_EncA_Pin|S1_EncB_Pin);
  ...
  else if(htim_encoder->Instance==TIM4)
  {
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, S3_EncA_Pin|S3_EncB_Pin);
  ...
  else if(htim_encoder->Instance==TIM5)
  {
    ...
    PA1     ------> TIM5_CH2
    */
    HAL_GPIO_DeInit(GPIOA, UI_EncA_Pin|UI_EncB_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART2)
  {
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, USART2_TX_MCU_Pin|USART2_RX_MCU_Pin);
